  ...
  extends Fragment
{
  ...
  public void onAttach(Activity paramActivity)
  {
    ...
    b.a(this.Cf, paramActivity);
  }
  
  public void onCreate(Bundle paramBundle)
  {
    super.onCreate(paramBundle);
    this.Cf.onCreate(paramBundle);
  }
  
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    return this.Cf.onCreateView(paramLayoutInflater, paramViewGroup, paramBundle);
  }
  ...
  public void onInflate(Activity paramActivity, AttributeSet paramAttributeSet, Bundle paramBundle)
  {
    ...
    this.Cf.onInflate(paramActivity, localBundle, paramBundle);
  }
  ...
  public void onSaveInstanceState(Bundle paramBundle)
  {
    ...
    this.Cf.onSaveInstanceState(paramBundle);
  }
    ...
    implements LifecycleDelegate
  {
    ...
    public a(Fragment paramFragment, IMapFragmentDelegate paramIMapFragmentDelegate)
    {
      ...
      this.Cg = ((Fragment)eg.f(paramFragment));
    }
    ...
    public void onCreate(Bundle paramBundle)
    {
      ...
      try
      {
        ...
        paramBundle = this.Cg.getArguments();
    ...
    extends a<SupportMapFragment.a>
  {
    ...
    public void ex()
    {
      ...
      try
      {
        ...
        this.BX.a(new SupportMapFragment.a(this.Cg, localIMapFragmentDelegate));
        return;
      }
      catch (RemoteException localRemoteException)
      {
...
/* Location:              G:\libgdx\sample_code\apk\libgdx-tests 0.6.4.3-dex2jar.jar!\com\google\android\gms\maps\SupportMapFragment.class
