  ...
  extends IInterface
{
  ...
  {
    public static IProjectionDelegate ag(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      case 1: 
        ...
        paramParcel1 = fromScreenLocation(b.a.E(paramParcel1.readStrongBinder()));
      ...
      case 2: 
        ...
        {
          b localb = toScreenLocation(paramParcel1);
          paramParcel2.writeNoException();
      ...
      implements IProjectionDelegate
    {
        ...
        throws RemoteException
      {
        ...
        //   33: aload_0
        //   34: getfield 18	com/google/android/gms/maps/internal/IProjectionDelegate$a$a:dU	Landroid/os/IBinder;
        //   37: iconst_1
        //   38: aload_3
        //   39: aload 4
        //   41: iconst_0
        ...
        //   60: ifeq +12 -> 72
        //   63: getstatic 63	com/google/android/gms/maps/model/LatLng:CREATOR	Lcom/google/android/gms/maps/model/LatLngCreator;
        //   66: aload 4
        //   68: invokevirtual 69	com/google/android/gms/maps/model/LatLngCreator:createFromParcel	(Landroid/os/Parcel;)Lcom/google/android/gms/maps/model/LatLng;
        //   71: astore_1
        //   72: aload 4
        ...
        throws RemoteException
      {
        ...
        //   14: aload_0
        //   15: getfield 18	com/google/android/gms/maps/internal/IProjectionDelegate$a$a:dU	Landroid/os/IBinder;
        //   18: iconst_3
        //   19: aload_2
        //   20: aload_3
        //   21: iconst_0
        ...
        //   36: ifeq +21 -> 57
        //   39: getstatic 80	com/google/android/gms/maps/model/VisibleRegion:CREATOR	Lcom/google/android/gms/maps/model/VisibleRegionCreator;
        //   42: aload_3
        //   43: invokevirtual 85	com/google/android/gms/maps/model/VisibleRegionCreator:createFromParcel	(Landroid/os/Parcel;)Lcom/google/android/gms/maps/model/VisibleRegion;
        //   46: astore_1
        //   47: aload_3
        ...
        throws RemoteException
      {
        ...
        //   29: aload_0
        //   30: getfield 18	com/google/android/gms/maps/internal/IProjectionDelegate$a$a:dU	Landroid/os/IBinder;
        //   33: iconst_2
        //   34: aload_2
        //   35: aload_3
        //   36: iconst_0
        ...
        //   51: invokestatic 104	com/google/android/gms/dynamic/b$a:E	(Landroid/os/IBinder;)Lcom/google/android/gms/dynamic/b;
        //   54: astore_1
        //   55: aload_3
        ...
        //   65: aload_2
        //   66: iconst_0
        //   67: invokevirtual 91	android/os/Parcel:writeInt	(I)V
        //   70: goto -41 -> 29
        //   73: astore_1
        //   74: aload_3
...
/* Location:              G:\libgdx\sample_code\apk\libgdx-tests 0.6.4.3-dex2jar.jar!\com\google\android\gms\maps\internal\IProjectionDelegate.class
