  ...
  implements SafeParcelable
{
  ...
  public final class Builder
  {
    ...
    {
      boolean bool2 = true;
      if (!TextUtils.isEmpty(NotifyTransactionStatusRequest.this.Gn))
      {
        bool1 = true;
        eg.b(bool1, "googleTransactionId is required");
      ...
      {
        eg.b(bool1, "status is an unrecognized value");
    ...
    {
      NotifyTransactionStatusRequest.this.GV = paramString;
      return this;
    }
    
    public Builder setGoogleTransactionId(String paramString)
    {
      NotifyTransactionStatusRequest.this.Gn = paramString;
      return this;
    }
...
/* Location:              G:\libgdx\sample_code\apk\libgdx-tests 0.6.4.3-dex2jar.jar!\com\google\android\gms\wallet\NotifyTransactionStatusRequest.class
