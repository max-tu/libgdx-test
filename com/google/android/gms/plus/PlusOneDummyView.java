  ...
  extends FrameLayout
{
  ...
  public PlusOneDummyView(Context paramContext, int paramInt)
  {
    ...
    paramContext.setBackgroundDrawable(eN().getDrawable(paramInt));
    Point localPoint = bi(paramInt);
    addView(paramContext, new FrameLayout.LayoutParams(localPoint.x, localPoint.y, 17));
  }
  
  private Point bi(int paramInt)
  {
    int j = 24;
    int i = 20;
...
/* Location:              G:\libgdx\sample_code\apk\libgdx-tests 0.6.4.3-dex2jar.jar!\com\google\android\gms\plus\PlusOneDummyView.class
