...
public final class GoogleMap
{
  ...
  {
    this.Br = ((IGoogleMapDelegate)eg.f(paramIGoogleMapDelegate));
  }
  ...
  public final Circle addCircle(CircleOptions paramCircleOptions)
  {
    try
    {
      paramCircleOptions = new Circle(this.Br.addCircle(paramCircleOptions));
  ...
  public final GroundOverlay addGroundOverlay(GroundOverlayOptions paramGroundOverlayOptions)
  {
    try
    {
      paramGroundOverlayOptions = this.Br.addGroundOverlay(paramGroundOverlayOptions);
  ...
  public final Marker addMarker(MarkerOptions paramMarkerOptions)
  {
    try
    {
      paramMarkerOptions = this.Br.addMarker(paramMarkerOptions);
  ...
  public final Polygon addPolygon(PolygonOptions paramPolygonOptions)
  {
    try
    {
      paramPolygonOptions = new Polygon(this.Br.addPolygon(paramPolygonOptions));
  ...
  public final Polyline addPolyline(PolylineOptions paramPolylineOptions)
  {
    try
    {
      paramPolylineOptions = new Polyline(this.Br.addPolyline(paramPolylineOptions));
  ...
  public final TileOverlay addTileOverlay(TileOverlayOptions paramTileOverlayOptions)
  {
    try
    {
      paramTileOverlayOptions = this.Br.addTileOverlay(paramTileOverlayOptions);
  ...
  public final void animateCamera(CameraUpdate paramCameraUpdate)
  {
    try
    {
      this.Br.animateCamera(paramCameraUpdate.el());
      return;
    }
  ...
  public final void animateCamera(CameraUpdate paramCameraUpdate, int paramInt, CancelableCallback paramCancelableCallback)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 99	com/google/android/gms/maps/GoogleMap:Br	Lcom/google/android/gms/maps/internal/IGoogleMapDelegate;
    //   4: astore 4
    //   6: aload_1
    //   7: invokevirtual 175	com/google/android/gms/maps/CameraUpdate:el	()Lcom/google/android/gms/dynamic/b;
    //   10: astore 5
    //   12: aload_3
    //   13: ifnonnull +17 -> 30
    //   16: aconst_null
    ...
    //   22: iload_2
    //   23: aload_1
    //   24: invokeinterface 183 4 0
    //   29: return
    //   30: new 68	com/google/android/gms/maps/GoogleMap$a
    //   33: dup
    //   34: aload_3
    //   35: invokespecial 186	com/google/android/gms/maps/GoogleMap$a:<init>	(Lcom/google/android/gms/maps/GoogleMap$CancelableCallback;)V
    //   38: astore_1
    //   39: goto -21 -> 18
    //   42: astore_1
    //   43: new 114	com/google/android/gms/maps/model/RuntimeRemoteException
    //   46: dup
    //   47: aload_1
    //   48: invokespecial 117	com/google/android/gms/maps/model/RuntimeRemoteException:<init>	(Landroid/os/RemoteException;)V
    //   51: athrow
  ...
  public final void animateCamera(CameraUpdate paramCameraUpdate, CancelableCallback paramCancelableCallback)
  {
    ...
    //   4: astore_3
    //   5: aload_1
    //   6: invokevirtual 175	com/google/android/gms/maps/CameraUpdate:el	()Lcom/google/android/gms/dynamic/b;
    //   9: astore 4
    //   11: aload_2
    //   12: ifnonnull +15 -> 27
    //   15: aconst_null
    ...
    //   26: return
    //   27: new 68	com/google/android/gms/maps/GoogleMap$a
    //   30: dup
    //   31: aload_2
    //   32: invokespecial 186	com/google/android/gms/maps/GoogleMap$a:<init>	(Lcom/google/android/gms/maps/GoogleMap$CancelableCallback;)V
    //   35: astore_1
    //   36: goto -19 -> 17
    //   39: astore_1
    //   40: new 114	com/google/android/gms/maps/model/RuntimeRemoteException
    //   43: dup
    //   44: aload_1
    //   45: invokespecial 117	com/google/android/gms/maps/model/RuntimeRemoteException:<init>	(Landroid/os/RemoteException;)V
    //   48: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  public final CameraPosition getCameraPosition()
  {
    try
    {
      CameraPosition localCameraPosition = this.Br.getCameraPosition();
  ...
  public final float getMaxZoomLevel()
  {
    try
    {
      float f = this.Br.getMaxZoomLevel();
      return f;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final float getMinZoomLevel()
  {
    try
    {
      float f = this.Br.getMinZoomLevel();
      return f;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final Location getMyLocation()
  {
    try
    {
      Location localLocation = this.Br.getMyLocation();
  ...
  public final Projection getProjection()
  {
    try
    {
      Projection localProjection = new Projection(this.Br.getProjection());
  ...
  public final UiSettings getUiSettings()
  {
    try
    {
      ...
      UiSettings localUiSettings = this.Bs;
  ...
  public final boolean isBuildingsEnabled()
  {
    try
    {
      boolean bool = this.Br.isBuildingsEnabled();
      return bool;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final boolean isIndoorEnabled()
  {
    try
    {
      boolean bool = this.Br.isIndoorEnabled();
      return bool;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final boolean isMyLocationEnabled()
  {
    try
    {
      boolean bool = this.Br.isMyLocationEnabled();
      return bool;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final boolean isTrafficEnabled()
  {
    try
    {
      boolean bool = this.Br.isTrafficEnabled();
      return bool;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final void moveCamera(CameraUpdate paramCameraUpdate)
  {
    try
    {
      this.Br.moveCamera(paramCameraUpdate.el());
      return;
    }
    catch (RemoteException paramCameraUpdate)
    {
  ...
  public final void setBuildingsEnabled(boolean paramBoolean)
  {
    try
    {
      this.Br.setBuildingsEnabled(paramBoolean);
      return;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final boolean setIndoorEnabled(boolean paramBoolean)
  {
    try
    {
      paramBoolean = this.Br.setIndoorEnabled(paramBoolean);
      return paramBoolean;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final void setInfoWindowAdapter(final InfoWindowAdapter paramInfoWindowAdapter)
  {
    ...
    this.Br.setInfoWindowAdapter(new d.a()
    {
      ...
      {
        return c.h(paramInfoWindowAdapter.getInfoWindow(new Marker(paramAnonymousd)));
      }
      
      public b g(d paramAnonymousd)
      {
        return c.h(paramInfoWindowAdapter.getInfoContents(new Marker(paramAnonymousd)));
      }
    });
  }
      ...
      public void activate(final g paramAnonymousg)
      {
        paramLocationSource.activate(new LocationSource.OnLocationChangedListener()
        {
          public void onLocationChanged(Location paramAnonymous2Location)
          {
            try
            {
              paramAnonymousg.g(c.h(paramAnonymous2Location));
              return;
            }
  ...
  public final void setMyLocationEnabled(boolean paramBoolean)
  {
    try
    {
      this.Br.setMyLocationEnabled(paramBoolean);
      return;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final void setOnMyLocationChangeListener(final OnMyLocationChangeListener paramOnMyLocationChangeListener)
  {
    ...
    this.Br.setOnMyLocationChangeListener(new n.a()
    {
      ...
      {
        paramOnMyLocationChangeListener.onMyLocationChange((Location)c.b(paramAnonymousb));
      }
    });
  }
  ...
  public final void setPadding(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    try
    {
      this.Br.setPadding(paramInt1, paramInt2, paramInt3, paramInt4);
      return;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public final void setTrafficEnabled(boolean paramBoolean)
  {
    try
    {
      this.Br.setTrafficEnabled(paramBoolean);
      return;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  {
    if (paramBitmap != null) {}
    for (paramBitmap = c.h(paramBitmap);; paramBitmap = null)
    {
      ...
      try
      {
        this.Br.snapshot(new o.a()
        {
          public void c(b paramAnonymousb)
            throws RemoteException
          {
            paramSnapshotReadyCallback.onSnapshotReady((Bitmap)c.b(paramAnonymousb));
          }
  ...
  private static final class a
    extends b.a
  {
    private final GoogleMap.CancelableCallback BI;
    
    a(GoogleMap.CancelableCallback paramCancelableCallback)
    {
      this.BI = paramCancelableCallback;
    }
...
/* Location:              G:\libgdx\sample_code\apk\libgdx-tests 0.6.4.3-dex2jar.jar!\com\google\android\gms\maps\GoogleMap.class
