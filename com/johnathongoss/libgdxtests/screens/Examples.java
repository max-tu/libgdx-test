  ...
  implements InputProcessor
{
  ...
  MyInputProcessor input = new MyInputProcessor()
  {
    public boolean keyUp(int paramAnonymousInt)
    {
      if ((paramAnonymousInt == 4) || (paramAnonymousInt == 67) || (paramAnonymousInt == 131)) {
        Examples.this.game.setScreen(new MainMenu(Examples.this.game));
      }
      return false;
    }
  };
  
  public Examples(MyGame paramMyGame)
  {
    super(paramMyGame);
    this.Text.add("Examples |");
    this.Text.add("screens that show a blend of tests together |");
  }
  ...
  public void show()
  {
    ...
    this.debugButton = new TextButton("Pop Corn", this.skin);
    ...
    this.debugButton.addListener(new ClickListener()
    {
      public void clicked(InputEvent paramAnonymousInputEvent, float paramAnonymousFloat1, float paramAnonymousFloat2)
      {
        Examples.this.game.setScreen(new PopCorns(Examples.this.game));
      }
    });
    this.buttons.add(this.debugButton);
    this.debugButton = new TextButton("Fish Tank", this.skin);
    this.debugButton.setHeight(this.BUTTON_HEIGHT);
    this.debugButton.setWidth(this.BUTTON_WIDTH);
    this.debugButton.addListener(new ClickListener()
    {
      public void clicked(InputEvent paramAnonymousInputEvent, float paramAnonymousFloat1, float paramAnonymousFloat2)
      {
        Examples.this.game.setScreen(new FishTank(Examples.this.game));
      }
    });
    this.buttons.add(this.debugButton);
    this.debugButton = new TextButton("Talking", this.skin);
    this.debugButton.setHeight(this.BUTTON_HEIGHT);
    this.debugButton.setWidth(this.BUTTON_WIDTH);
    this.debugButton.addListener(new ClickListener()
    {
      public void clicked(InputEvent paramAnonymousInputEvent, float paramAnonymousFloat1, float paramAnonymousFloat2)
      {
        Examples.this.game.setScreen(new Talking(Examples.this.game));
      }
    });
    this.buttons.add(this.debugButton);
    this.debugButton = new TextButton("Volunteer", this.skin);
    this.debugButton.setHeight(this.BUTTON_HEIGHT);
    this.debugButton.setWidth(this.BUTTON_WIDTH);
    this.debugButton.addListener(new ClickListener()
    {
      public void clicked(InputEvent paramAnonymousInputEvent, float paramAnonymousFloat1, float paramAnonymousFloat2)
      {
        Examples.this.game.setScreen(new Volunteer(Examples.this.game));
      }
    });
    this.buttons.add(this.debugButton);
...
/* Location:              G:\libgdx\sample_code\apk\libgdx-tests 0.6.4.3-dex2jar.jar!\com\johnathongoss\libgdxtests\screens\Examples.class
