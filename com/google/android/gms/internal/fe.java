...
{
  private static final Pattern qC = Pattern.compile("\\\\.");
  private static final Pattern qD = Pattern.compile("[\\\\\"/\b\f\n\r\t]");
  ...
  public static String aa(String paramString)
  {
    ...
    {
      localMatcher = qD.matcher(paramString);
      localObject1 = null;
...
/* Location:              G:\libgdx\sample_code\apk\libgdx-tests 0.6.4.3-dex2jar.jar!\com\google\android\gms\internal\fe.class
