  ...
  implements InputProcessor
{
  ...
  MyInputProcessor input = new MyInputProcessor()
  {
    public boolean keyUp(int paramAnonymousInt)
    {
      if ((paramAnonymousInt == 4) || (paramAnonymousInt == 67) || (paramAnonymousInt == 131)) {
        SpeechTest.this.game.setScreen(new MainMenu(SpeechTest.this.game));
      }
      return false;
    }
  };
  ...
  public SpeechTest(MyGame paramMyGame)
  {
    super(paramMyGame);
  }
  ...
  public void show()
  {
    ...
    final Object localObject = new InputMultiplexer(new InputProcessor[] { this.stageui, this.stage, this, this.input });
    Gdx.input.setInputProcessor((InputProcessor)localObject);
    Gdx.input.setCatchBackKey(true);
    localObject = new TextButton("Back", this.skin);
    ((TextButton)localObject).setBounds(0.0F, this.height - this.BUTTON_HEIGHT * 2.0F, this.BUTTON_WIDTH, this.BUTTON_HEIGHT);
    ...
    ((TextButton)localObject).addListener(new ClickListener()
    {
      public void clicked(InputEvent paramAnonymousInputEvent, float paramAnonymousFloat1, float paramAnonymousFloat2)
      {
        paramAnonymousInputEvent = SpeechTest.this;
        if (SpeechTest.this.usePics) {}
        for (boolean bool = false;; bool = true)
        {
          paramAnonymousInputEvent.usePics = bool;
          localObject.setText("Pics: " + SpeechTest.this.usePics);
          return;
        }
      }
    });
...
/* Location:              G:\libgdx\sample_code\apk\libgdx-tests 0.6.4.3-dex2jar.jar!\com\johnathongoss\libgdxtests\tests\SpeechTest.class
