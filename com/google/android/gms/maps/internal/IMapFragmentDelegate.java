  ...
  extends IInterface
{
  ...
  {
    public static IMapFragmentDelegate U(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      case 2: 
        paramParcel1.enforceInterface("com.google.android.gms.maps.internal.IMapFragmentDelegate");
        localb1 = b.a.E(paramParcel1.readStrongBinder());
        ...
        {
          onInflate(localb1, localGoogleMapOptions, paramParcel1);
          paramParcel2.writeNoException();
          return true;
      ...
      case 4: 
        paramParcel1.enforceInterface("com.google.android.gms.maps.internal.IMapFragmentDelegate");
        localb1 = b.a.E(paramParcel1.readStrongBinder());
        b localb2 = b.a.E(paramParcel1.readStrongBinder());
        if (paramParcel1.readInt() != 0) {}
        for (paramParcel1 = (Bundle)Bundle.CREATOR.createFromParcel(paramParcel1);; paramParcel1 = null)
        {
          localb1 = onCreateView(localb1, localb2, paramParcel1);
          paramParcel2.writeNoException();
      ...
      implements IMapFragmentDelegate
    {
        ...
        throws RemoteException
      {
        ...
        try
        {
          ...
          IGoogleMapDelegate localIGoogleMapDelegate = IGoogleMapDelegate.a.R(localParcel2.readStrongBinder());
        ...
        throws RemoteException
      {
        ...
        //   29: aload_0
        //   30: getfield 18	com/google/android/gms/maps/internal/IMapFragmentDelegate$a$a:dU	Landroid/os/IBinder;
        //   33: iconst_3
        //   34: aload_2
        //   35: aload_3
        //   36: iconst_0
        ...
        throws RemoteException
      {
        ...
        //   74: aload_0
        //   75: getfield 18	com/google/android/gms/maps/internal/IMapFragmentDelegate$a$a:dU	Landroid/os/IBinder;
        //   78: iconst_4
        //   79: aload 5
        //   81: aload 6
        //   83: iconst_0
        ...
        //   100: invokestatic 92	com/google/android/gms/dynamic/b$a:E	(Landroid/os/IBinder;)Lcom/google/android/gms/dynamic/b;
        //   103: astore_1
        //   104: aload 6
...
/* Location:              G:\libgdx\sample_code\apk\libgdx-tests 0.6.4.3-dex2jar.jar!\com\google\android\gms\maps\internal\IMapFragmentDelegate.class
