...
public final class Projection
{
  ...
  {
    this.Ce = paramIProjectionDelegate;
  }
  ...
  public LatLng fromScreenLocation(Point paramPoint)
  {
    try
    {
      paramPoint = this.Ce.fromScreenLocation(c.h(paramPoint));
      return paramPoint;
    }
  ...
  public Point toScreenLocation(LatLng paramLatLng)
  {
    try
    {
      paramLatLng = (Point)c.b(this.Ce.toScreenLocation(paramLatLng));
      return paramLatLng;
    }
...
/* Location:              G:\libgdx\sample_code\apk\libgdx-tests 0.6.4.3-dex2jar.jar!\com\google\android\gms\maps\Projection.class
