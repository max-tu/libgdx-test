...
public final class co
{
  ...
  public static void a(Context paramContext, String paramString, List<String> paramList)
  {
    ...
    while (paramList.hasNext()) {
      new cr(paramContext, paramString, (String)paramList.next()).start();
    }
  }
  ...
  private static String b(Context paramContext, String paramString)
  {
    for (;;)
    {
      synchronized (hC)
      {
        ...
        {
          iE = cq.getDefaultUserAgent(paramContext);
          iE = iE + " (Mobile; " + paramString + ")";
          paramContext = iE;
          return paramContext;
        }
      }
...
/* Location:              G:\libgdx\sample_code\apk\libgdx-tests 0.6.4.3-dex2jar.jar!\com\google\android\gms\internal\co.class
